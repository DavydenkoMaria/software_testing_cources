...
public class ContactCreationTest {
    ...
    public void testContactCreation() {
        initContactCreation();
        fillContactForm(new ContactShortData("Maria", "Davydenko", "Russia, Novosibirsk", "9998887766", "masha@gmail.com", "test"));
    ...
    private void fillContactForm(ContactShortData contactShortData) {
